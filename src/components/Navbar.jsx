...
export default function Navbar() {
  ...
  return (
    <>
      <Disclosure
        as="nav"
        className="bg-neutral-100 dark:bg-gray-900 py-3 dark:text-white fixed w-full z-20 top-0 pt-6 pb-6 "
      >
        {({ open }) => (
          <>
      ...
      <div className="h-[56px] bg-neutral-100 dark:bg-gray-900 py-3"></div>
    </>
  );
}
